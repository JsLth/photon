...
This outlines how to propose a change to photon.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("JsLth/photon", fork = TRUE)`.
...
Please note that the photon project is released with a
