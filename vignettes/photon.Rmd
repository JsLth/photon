...
#> ℹ Fetching photon 0.5.0.
#> ✔ Successfully downloaded photon 0.5.0. [7.4s]
#> 
#> 
#> ℹ Fetching search index for ws, created on latest
#> ✔ Successfully downloaded search index. [510ms]  
#> 
#> 
#> • Version: 0.5.0
#> 
...
#> 2024-10-18 21:50:43,331 [main] WARN  org.elasticsearch.node.Node - version [5.6.16-SNAPSHOT] is a pre-release version of Elasticsearch and is not suitable for production
#> 2024-10-18 21:50:49,126 [main] INFO  de.komoot.photon.elasticsearch.Server - Started elastic search node
#> 2024-10-18 21:50:49,126 [main] INFO  de.komoot.photon.App - Make sure that the ES cluster is ready, this might take some time.
#> 2024-10-18 21:50:49,494 [main] INFO  de.komoot.photon.App - ES cluster is now ready.
```
...
#> 1 "geocode(\"Apai\", limit = 1)"   17.8ms   20.7ms      47.9      97KB     1.99
```
...
#>   expression                          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>                     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 "geocode(\"Apai\", limit = 1)"    273ms    1.04s     0.914     107KB   0.0381
```
