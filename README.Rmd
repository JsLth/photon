...
- The [`{revgeo}`](https://cran.r-project.org/web/packages/revgeo/index.html) by Michael Hudecheck package implements reverse geocoding using (among others) photon.
- The [`{MazamaLocationUtils}`](https://cran.r-project.org/web/packages/MazamaLocationUtils/) by Mazama Science packages features reverse geocoding using photon.
